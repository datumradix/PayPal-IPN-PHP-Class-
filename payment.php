...
switch ($_GET['action']) {
   ...
   case 'process':      // Process and order...
     ...
     // $p->add_field('business', 'receiver email id');
      $p->add_field('cmd', '_s-xclick');
      $p->add_field('hosted_button_id', 'Hosted Button ID');
      $p->add_field('os0', 'Option 2');
   ...
   case 'ipn':          // Paypal is calling page for IPN validation...
      ...
      if ($p->validate_ipn()) {
         ...
         $to = 'your email id';    //  your email
         $body =  "An instant payment notification was successfully recieved\n";
         $body .= "from ".$p->ipn_data['payer_email']." on ".date('m/d/Y');
         $body .= " at ".date('g:i A')."\n\nDetails:\n";
         
         //foreach ($p->ipn_data as $key => $value) { $body .= "\n$key: $value"; }
         $resp=sendmail($to,$from,$subject,$body);
        
      }
      else{
            $subject = 'Ivalid Payment Notification - Recieved Payment';
        $from = 'admin@example.com';
         $to = 'your email id';    //  your email
         $body =  "An instant payment notification was successfully recieved\n";
         $body .= "from ".$p->ipn_data['payer_email']." on ".date('m/d/Y');
